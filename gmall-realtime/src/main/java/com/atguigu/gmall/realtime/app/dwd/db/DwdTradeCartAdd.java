...
import com.atguigu.gmall.realtime.bean.TradeCartAddBean;
...
//        System.setProperty("HADOOP_USER_NAME", "atguigu");
        ...
        Table cartAdd = tableEnv.sqlQuery("" +
                ...
                "data['sku_id'] sku_id,\n" +
                "from_unixtime(cast(ts as int),'yyyy-MM-dd') date_id,\n" +
                "from_unixtime(cast(ts as int),'yyyy-MM-dd HH:mm:ss') create_time,\n" +
                "data['source_id'] source_id,\n" +
                "data['source_type'] source_type,\n" +
                "if((`type` = 'insert' or `type` = 'bootstrap-insert'),\n" +
...
//        DataStream<TradeCartAddBean> tradeCartAddBeanDataStream = tableEnv.toAppendStream(resultTable, TradeCartAddBean.class);
//        tradeCartAddBeanDataStream.print("tradeCartAddBeanDataStream");
//
//        Table table = tableEnv.fromDataStream(tradeCartAddBeanDataStream);
//        tableEnv.createTemporaryView("cart_add_table", table);
//        tableEnv.sqlQuery("select * from cart_add_table")
//                .execute()
//                .print();
