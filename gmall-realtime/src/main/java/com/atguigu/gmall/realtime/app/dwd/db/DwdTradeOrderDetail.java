...
//        tableEnv.sqlQuery("select id, order_id, split_original_amount from order_detail limit 10")
//                .execute()
//                .print();
...
//        tableEnv.sqlQuery("" +
//                "select id, user_id, province_id from order_info limit 10")
//                .execute()
//                .print();
...
//        tableEnv.sqlQuery("" +
//                "select * from order_detail_activity limit 10")
//                .execute()
//                .print();
...
//        tableEnv.sqlQuery("" +
//                "select * from order_detail_coupon limit 10")
//                .execute()
//                .print();
...
//        tableEnv.sqlQuery("" +
//                "select " +
//                "id, activity_id, activity_rule_id," +
//                "coupon_id, split_activity_amount, split_coupon_amount, " +
//                "source_type," +
//                "source_type_name\n" +
//                "from result_table " +
...
//                .print();
        ...
        // TODO 10. 建立 Upsert-Kafka dwd_trade_order_detail 表
        tableEnv.executeSql("" +
